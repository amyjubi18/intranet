...
<div class="mt-1 mb-2">
    ...
    <div class="mt-3">
        ...
        <a class="text-center w-full bg-blue-900 items-center px-4 py-3  rounded-lg font-semibold text-white  hover:bg-blue-800 md:w-fit sm:w-fit" href="./documentos.php">Regresar</a>
        </div>
    </form>
    </div>
        		</div>
