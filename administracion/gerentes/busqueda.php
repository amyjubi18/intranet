...
?>
    ...
    <table id="tabla" class='w-full text-gray-800 dark:text-gray-400 border-solid border-gray-600 sm:p-4' >
        ...
        <tr class=" border-4 border-blue-400">
            ...
            <th scope='col' class='py-4 px-6 text-center border-4 border-blue-900'>Acciones</th>
...
echo"<th class='py-3 px-8 border border-4 border-blue-900' scope='row'>".$contador."</th>";
echo"<td class='py-3 px-8 border border-4 border-blue-900'>".$datos['name']."</td>";
 echo"<td class='py-3 px-8 border border-4 border-blue-900'>".$datos['description']."</td>";
echo"<td class='py-3 px-8 border border-4 border-blue-900'>".$datos['ruta']."</td>";
echo"<td class='py-3 px-8 border border-4 border-blue-900'>".$datos['fecha']."</td>";
echo"<td class='py-3 px-8 border border-4 border-blue-900'>".$datos['Categoria']."</td>";
echo "<td class=' border-2 border-blue-900 text-center py-4'><a class='focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800' style='margin-left: 0.5rem;' target='_blank' href=' $ruta'>Visualizar</a></td>";
echo"</tr>";
echo"  </tbody>";
