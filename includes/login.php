    ...
    <section class="flex flex-col md:flex-row h-screen items-center border-4 border-blue-900 rounded ">
        ...
        <div class=" bg-white items-center justify-center flex md:mx-auto md:mx-0 md:max-w-md lg:max-w-full w-full md:w-1/2 xl:w-1/3 px-6 lg:px-16 xl:px-12 snap-none">
            <div class="w-full h-200  touch-none">
                ...
                <!-----------FORMULARIO-------------->
                <form class="mt-0" action="_functions.php" method="POST" autocomplete="off" >
                    <div class="">
                        <label class="block text-gray-700" for="email">Correo o Usuario:</label>
                        <input type="text" placeholder="Ingresa el Usuario o el Correo" class="w-full bg-gray-200 mt-2 border focus:border-blue-900 focus:bg-white focus:outline-none rounded-lg px-4 py-3" autocomplete="off" autofocus required name="Usuarios" id="Usuarios">
                    </div>
                    <div class="mt-1">
                        <label class="block text-gray-700" for="Clave">Contraseña:</label>
                        <input type="password" minlength="6" placeholder="Ingresa la Contraseña"  class="w-full bg-gray-200 mt-2 border focus:border-blue-900 focus:bg-white focus:outline-none rounded-lg px-4 py-3" required name="Clave" id="Clave" autocomplete="off">
